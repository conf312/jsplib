package com.jsplib.users.config;

import com.jsplib.users.handler.AuthFailureHandler;
import com.jsplib.users.handler.AuthSuccessHandler;
...
public class SecurityConfig {
    ...
    private static final String[] ALLOW_PATH = {"/", "/member/**", "/common/**"};
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        */
        ...
        http.csrf().disable()
            ...
            .and()
            .formLogin() // 로그인 폼은
            .loginPage("/member/signin") // 해당 주소로 로그인 페이지를 호출한다.
            .usernameParameter("email")
            .passwordParameter("password")
            .loginProcessingUrl("/member/signin/action") // 해당 URL로 요청이 오면 스프링 시큐리티가 가로채서 로그인처리를 한다. -> loadUserByName
            ...
            .logoutSuccessUrl("/member/signin") // 성공시 리턴 URL
            ...
            .expiredUrl("/member/signin") // 세션이 만료된 경우 이동 할 페이지를 지정
            .and()
